/**
 *
 * This slide behaviour is from the JavaScript within the 'DZSlides' template
...
Dz.onhashchange = function() {
    ...
    for (var i = 0; i < this.remoteWindows.length; i++) {
        this.postMsg(this.remoteWindows[i], "CURSOR", this.idx + "." + this
            .step);
    }
}
...
Dz.setIncremental = function(aStep) {
    this.step = aStep;
    var incrementals = Array.prototype.slice.call(this.slides[this.idx - 1]
        .$$('.next')).sort(function(a, b) {
        return Number(a.getAttribute('next-order')) - Number(b.getAttribute(
            'next-order'));
    });
...
Dz.goFullscreen = function() {
    var html = $('html'),
        requestFullscreen = html.requestFullscreen || html.requestFullScreen ||
...
Dz.setProgress = function(aIdx, aStep) {
    ...
    this.progressBar.style.width = ((aIdx - 1) * slideSize + aStep *
        stepSize) + '%';
}
